...
public class ConfirmDialogExemple implements Runnable {
	public void run() {
		...
		b.addActionListener(new ConfirmListener(fenetre, l));

		fenetre.pack();
		fenetre.setVisible(true);
	}
	public static void main(String []args) {
		SwingUtilities.invokeLater(new ConfirmDialogExemple());
	}
}

...
public class ModelessListener implements ActionListener {
	private JFrame theFrame;
	public ModelessListener(JFrame f) { theFrame = f; }
	public void actionPerformed(ActionEvent e) {
		final JDialog dialog = new JDialog(theFrame); // void/null or theFrame...
		if (theFrame!=null) {
			dialog.setTitle("Attached to "+theFrame.getTitle());
			dialog.setLocationRelativeTo(theFrame);
		}
		Dialog.ModalityType type = Dialog.ModalityType.MODELESS;

...
public class DocumentModalExemple implements Runnable {
	public void run() {
		...
		b1.addActionListener(new DocumentModalListener(fenetre1));
		...
		b2.addActionListener(new DocumentModalListener(fenetre2));
	...
	public static void main(String []args) {
		SwingUtilities.invokeLater(new DocumentModalExemple());
	}
}
...
public class AppModalExemple implements Runnable {
	public void run() {
		...
		b1.addActionListener(new AppModalListener(fenetre1));
		...
		b2.addActionListener(new AppModalListener(fenetre2));
	...
	public static void main(String []args) {
		SwingUtilities.invokeLater(new AppModalExemple());
	}
}
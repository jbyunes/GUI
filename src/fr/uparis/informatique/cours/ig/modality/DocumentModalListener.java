...
public class DocumentModalListener implements ActionListener {
	private JFrame theFrame;
	public DocumentModalListener(JFrame f) { theFrame = f; }
	public void actionPerformed(ActionEvent e) {
		...
		Dialog.ModalityType type = Dialog.ModalityType.DOCUMENT_MODAL;
